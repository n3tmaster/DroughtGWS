...
#gdalwarp -of GTiff -t_srs 'EPSG:4326' 'HDF4_EOS:EOS_GRID:/tmp/tomcat7-tomcat7-tmp/prodlst0.hdf:MODIS_Grid_8Day_1km_LST:LST_Day_1km' /tmp/tomcat7-tomcat7-tmp/hdfoutlst"$icount".tif
...
ILCOMANDO="curl -X POST  https://droughtsdi.fi.ibimet.cnr.it/dgws/api/organize/j_organize_lst/$year/$doy/$tile_ref"
